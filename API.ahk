; =================================================================================================
; | SA:MP 0.3.7 R1 (SA:MP-CAC) Autohotkey API
; | API based on UDF
; | Modified by: Abrucci
; | License: GnuGLPv3
; =================================================================================================
...
printPlayerTextdraws(){
    ...
    showDialog(DIALOG_STYLE_TABLIST_HEADERS, prefix . "Textdraws", "ID`tText`tTyp`n" Textdraws "`n `nGesamte Textdraws: " i, "Schließen")
    return true
}
